...
const design0 = document.querySelector('.design0');
...
link.forEach(r => {
    r.addEventListener('click', () => {
        ...
        design0.textContent = changeLanguage[attr].design0;
        design1.textContent = changeLanguage[attr].design1;
        design2.textContent = changeLanguage[attr].design2;
...
let changeLanguage = {
    ...
    "espanish":
    {
        ...
        "design0": "Un único pase para verlo todo. Ahorra hasta un 50% en las mejores actividades, tours y atracciones turísticas con Go City®.",
        "design1": "Los mejores destinos para vacacionar en familia.",
        "design2": "¡Descubre el mundo con nuestra agencia de viajes de ensueño!, nos dedicamos a hacer realidad tus sueños de aventura. Desde playas exóticas hasta ciudades vibrantes, que se adaptan a tus gustos y preferencias. Con expertos en destinos de todo el mundo, garantizamos experiencias inolvidables y momentos que perdurarán toda la vida.",
    ...
    "english":
    {
        ...
        "design0": "A single pass to see everything. Save up to 50% on the best activities, tours and tourist attractions with Go City®",
        "design1": "The best destinations for family vacations.",
        "design2": "Discover the world with our dream travel agency! We are dedicated to making your adventure dreams come true. From exotic beaches to vibrant cities, they adapt to your tastes and preferences. With experts in destinations around the world, we guarantee unforgettable experiences and moments that will last a lifetime.",
